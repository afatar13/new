...
sudo_users = {SUDO,1135359831,1135359831}   
...
os.execute('wget https://raw.githubusercontent.com/frwndyf/fer/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ❍ تم تحديث السورس \n ❍ لديك اخر اصدار لسورس افاتار\n ❍ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❍ اصدار سورس افاتار \n ❍ الاصدار »{ v 1.5}')
end
...
if text == '≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑 ༗━━━━━━≫' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/php_14)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑 ༗━━━━━━≫', url="t.me/php_14"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' or text == 'سورس افاتار' then 
local Text = [[ 
┍━━━━━☞ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑](https://t.me/php_14 ) ☜━━━━━┑
𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑
𝑻𝑯𝑬𝑺𝑻𝑹𝑶𝑵𝑮𝑬𝑺𝑻 𝑺𝑶𝑼𝑹𝑪𝑬 𝑰𝑵 𝑻𝑬𝑳𝑬𝑮𝑹𝑨𝑴 
┕━━━━━☞ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑](https://t.me/php_14 ) ☜━━━━━┙
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐀𝐅𝐀𝐓𝐀𝐑 ༗ ',url="t.me/php_30"},{text = '  𝙁𝙍𝘼𝙒𝙉  ',url="t.me/DEV_FRAWN"}}, 
{{text = '[𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑 ༗]', url="t.me/php_14"}}, 

} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/php_14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗧𝗛𝗘 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑 ༗ ❍
❍اهلا بك في سورس افاتار  الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ❍
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩𝐀𝐅𝐀𝐓𝐀𝐑 ༗𓆪',url="t.me/php_30"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == '𝐀𝐅𝐀𝐓𝐀𝐑 ༗' then
local Text = [[
المبرمج افاتار لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/php_30&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'مالك سورس' then
local Text = [[
المبرمج افاتار لو حابب تكلمو 
اتبع الزر إلى تحت ↓
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑 ༗𓆪', url="t.me/php_14"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if result.sender_user_id_ == tonumber(1135359831) then
send(msg.chat_id_, msg.id_, " ❍ لا يمكنك حظر المرمج الكبير افاتار\n")
return false 
end
if result.sender_user_id_ == tonumber(1135359831) then
send(msg.chat_id_, msg.id_, " ❍ لا يمكنك حظر افاتار\n")
return false 
end
if result.sender_user_id_ == tonumber(1135359831) then
send(msg.chat_id_, msg.id_, " ❍ لا يمكنك حظر افاتار \n")
...
if result.sender_user_id_ == tonumber(1135359831) then
send(msg.chat_id_, msg.id_, " ❍ لا يمكنك كتم افاتار\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
database:set(bot_id.."php_14:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."php_14:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."php_14:insta_bot"..msg.chat_id_) == "open" then
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/php_14)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/php_14)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/php_14)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/php_14)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/php_14)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂❍](t.me/php_14)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/php_14)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/php_14)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/php_14)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[عضو قميل 😉](t.me/php_14)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/php_14)') 
return false
end

if text == 'حصل' or text == 'حص' then
send(msg.chat_id_,msg.id_, '[حصل حصوله😂🎶](t.me/php_14)') 
return false
end

if text == 'صلي علي الحبيب' or text == 'محمد عليه السلام' then
send(msg.chat_id_,msg.id_, '[عليه افضل الصلاة والسلام 💙📿](t.me/php_14)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[تدوم الضحكه يا روحي 🌝❤](t.me/php_14)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/php_14)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/php_14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/php_14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/php_14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/php_14)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/php_14)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/php_14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/php_14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/php_14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/php_14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/php_14)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/php_14)') 
return false
end
end
end
...
اوامر سورس افاتار الاوامر خاصه ب الادمن 🕹️
[🇪🇬 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑 ༗ 🇪🇬](t.me/php_14)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑 ༗', url="t.me/php_14"},
{text = 'مبرمج السورس', url="t.me/php_30"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'افاتار')
...
--local curl = 'curl "'..'https://api.telegram.org/bot1564973291:AAF2IwSno-EITmF3sGz40dGXKVNKNaUn0wI/sendDocument'..'" -F "chat_id='.. 1135359831 ..'" -F "document=@'..'frawn.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
